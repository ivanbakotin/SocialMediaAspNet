...
namespace MyAppBackend.ActionFilters
{
    public class GroupOwnerAdminFilter : IActionFilter
    {
        ...
        public GroupOwnerAdminFilter(DataContext context)
        {
        ...
        public void OnActionExecuting(ActionExecutingContext _context)
        {
            ...
            bool isOwnerOrAdmin = context.GroupMembers.Any(x => x.GroupID == GroupID && x.UserID == UserID && (x.RoleID == 3 || x.RoleID == 1));
